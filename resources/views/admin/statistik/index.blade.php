<x-layout-admin>
    <x-slot:title>Statistik - Admin</x-slot:title>
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex items-center justify-between bg-neutral-50 rounded-xl p-4">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-neutral-900">{{ $userCount }}</p>
                                </div>
                            ...
                            <div class="flex items-center justify-between bg-neutral-50 rounded-xl p-4">
                                <div>
                                    ...
                                    <p class="text-2xl font-bold text-neutral-900">{{ $bengkelCount }}</p>
                                </div>
                                <div class="text-neutral-400">
                                    <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
