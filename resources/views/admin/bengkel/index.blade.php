                                ...
                                @if(isset($bengkels) && $bengkels->count())
                                    @foreach($bengkels as $b)
                                        <tr data-status="terdaftar">
                                            ...
                                            <td class="px-6 py-6 text-right">
                                                <a href="{{ route('admin.cekAktivitas', ['id_bengkel' => $b->id_bengkel]) }}" class="px-3 py-1.5 text-sm font-medium rounded-full border border-primary-200 text-primary-600 bg-primary-50 hover:bg-primary-100">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
