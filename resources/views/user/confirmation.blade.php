<x-layout-user>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-md mx-auto">
                ...
                <div class="card p-4 mb-4">
                    <h4 class="font-semibold text-neutral-900 mb-1">{{ $bengkel->nama_bengkel }}</h4>
                    <p class="text-sm text-neutral-600">{{ $bengkel->alamat_lengkap }}</p>
                ...
                <form id="orderForm" action="{{ route('user.order_store') }}" method="POST" class="space-y-4">
                    ...
                    <input type="hidden" id="idLayanan" name="id_layanan_bengkel" value="{{ $layanan_bengkel->id_layanan_bengkel ?? '' }}">
                    <input type="hidden" id="idUser" name="id_user" value="{{ $id_user->id_user ?? '' }}">
                    ...
                    <div>
                        ...
                        {{-- <textarea id="orderNotes" placeholder="Tambahkan catatan untuk bengkel..." class="input w-full text-sm" rows="6"></textarea> --}}
                        <textarea 
                            id="orderNotes" 
                            name="notes"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="border-t border-neutral-200 pt-2 mt-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-primary-700 text-lg" id="totalPrice">Rp {{ number_format($layanan_bengkel->harga_akhir, 0, ',', '.') }}</span>
                                </div>
                            </div>
                        </div>
                        {{-- <button type="submit" class="flex-1 btn btn-primary mt-8">
                            Konfirmasi
                        </button> --}}
                    </div>
                </form>
    ...
    <script>
        ...
        const SERVICE_PRICE = {{ $layanan_bengkel->harga_akhir }};
        ...
        function initMap() {
            ...
            if (bengkelLat && bengkelLng) {
                ...
                bengkelMarker = L.marker([bengkelLat, bengkelLng], { icon: bengkelIcon })
                    .addTo(map)
                    .bindPopup('<b>{{ $bengkel->nama_bengkel }}</b><br>{{ $bengkel->alamat_lengkap }}');
            }
        }
                    ...
                    <div class="text-left">
                        ...
                        <div class="space-y-2 text-sm">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium">{{ $layanan_bengkel->nama_layanan }}</span>
                            </div>
                            <div class="flex justify-between">
