<x-layout-user>
        ...
        <div class="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div class="sticky top-0 bg-white border-b border-neutral-200 px-6 py-4 rounded-t-2xl">
                <div class="flex items-center justify-between">
                    ...
                    <button onclick="closeOrderModal()" class="w-8 h-8 rounded-full flex items-center justify-center hover:bg-neutral-100 transition">
            ...
            <div class="px-6 py-4">
                ...
                <div class="mb-4 pb-4 border-b border-neutral-200">
                    ...
                    <p class="text-sm text-neutral-600">0.6 km • 15 menit</p>
                </div>

                <!-- Pilih Layanan -->
                <div class="mb-4">
                    <label class="block text-sm font-semibold text-neutral-900 mb-2">Pilih Layanan</label>
                    <select id="serviceSelect" onchange="calculateTotal()" class="select w-full text-sm">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="text" id="userLocation" placeholder="Mendeteksi lokasi..." class="input w-full pr-12 text-xs" readonly>
                        <button onclick="getUserLocation()" class="absolute right-2 top-1/2 -translate-y-1/2 text-primary-600 hover:text-primary-700 p-1">
                ...
                <div class="bg-neutral-50 rounded-xl p-4 mb-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-between text-sm">
                            <span class="text-neutral-600">Ongkir (0.6 km)</span>
                            <span class="font-medium text-neutral-900">Rp 6.000</span>
                        </div>
                ...
                <div class="flex gap-3 mt-6">
                    <button onclick="closeOrderModal()" class="flex-1 btn btn-outline">
                        Batal
                    </button>
    ...
    <script>
        ...
        function calculateDistance(userLat, userLon) {
            ...
            const ongkir = Math.ceil(distance * 10000); // Rp 10.000 per km
            document.querySelector('.flex.justify-between:has(+ .border-t) .text-neutral-600').textContent = 
                `Ongkir (${distance.toFixed(1)} km)`;
            
            // Update total
            calculateTotal(ongkir);
        }

        function calculateTotal(customOngkir = 6000) {
            ...
            const ongkirElements = document.querySelectorAll('.flex.justify-between .font-medium.text-neutral-900');
            if (ongkirElements.length >= 2) {
                ongkirElements[1].textContent = 'Rp ' + ongkir.toLocaleString('id-ID');
            }
        ...
        function confirmOrder() {
            ...
            if (!location) {
                alert('Silakan masukkan lokasi Anda');
                return;
            }

            // Simulasi konfirmasi
            alert('Pesanan berhasil! Teknisi akan segera menghubungi Anda.');
            closeOrderModal();
