<x-layout-user>
    ...
    <script>
        ...
        const countdownInterval = setInterval(() => {
            ...
            if (timeLeft <= 30) {
                countdownDisplay.classList.add('text-error-600');
                countdownDisplay.classList.remove('text-warning-600');
            }
        ...
        // Simulate bengkel confirmation (for testing - remove in production)
        // Uncomment below to test confirmation flow
        /*
        setTimeout(() => {
            clearInterval(countdownInterval);
            alert('Bengkel telah mengkonfirmasi pesanan Anda!');
            // Redirect to next page (e.g., tracking page)
            // window.location.href = '/bengkel/tracking';
        }, 10000); // Simulate confirmation after 10 seconds
        */
    </script>
    @endpush
