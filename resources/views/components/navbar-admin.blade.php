...
<header class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <a href="{{ route('admin.dashboard.index') }}" class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs bg-primary-100 text-primary-700 px-2 py-1 rounded font-semibold">Admin</span>
            </div>
        </a>
        ...
        <nav class="hidden lg:flex items-center gap-6">
            <a href="{{ route('admin.dashboard.index') }}" class="text-neutral-700 hover:text-primary-700 transition font-medium">
                Dashboard
            </a>
            <a href="{{ route('admin.users.index') }}" class="text-neutral-700 hover:text-primary-700 transition font-medium">
                Kelola User
            </a>
            <a href="{{ route('admin.dashboard.index') }}" class="text-neutral-700 hover:text-primary-700 transition font-medium">
                Calon Bengkel
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 z-50">
                    <a href="{{ route('admin.dashboard.index') }}" class="block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-50 transition">
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('admin.users.index') }}" class="block px-4 py-2 text-sm text-neutral-700 hover:bg-neutral-50 transition">
                        <div class="flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <nav id="mobileMenu" class="hidden lg:hidden bg-white border-t border-neutral-200">
        <div class="container mx-auto px-4 py-4 flex flex-col gap-3">
            <a href="{{ route('admin.dashboard.index') }}" class="text-neutral-700 hover:text-primary-700 py-2 transition font-medium">Dashboard</a>
            <a href="{{ route('admin.users.index') }}" class="text-neutral-700 hover:text-primary-700 py-2 transition font-medium">Kelola User</a>
            <a href="{{ route('admin.dashboard.index') }}" class="text-neutral-700 hover:text-primary-700 py-2 transition font-medium">Calon Bengkel</a>
