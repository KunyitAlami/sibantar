                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <input type="tel" id="wa_number" name="wa_number" class="input @error('wa_number') border-danger-500 @enderror" placeholder="08123456789" value="{{ old('wa_number') }}" required>
