...
<?php $component->withAttributes([]); ?>
    ...
    <section class="py-6 bg-gradient-to-b from-neutral-50 to-white min-h-screen">
        <div class="container mx-auto px-4">
            <h2 class="text-xl font-bold text-neutral-900 mb-4">Daftar Pesanan</h2>

            <!-- Order 1 - Menunggu Persetujuan -->
            <div class="bg-white rounded-2xl p-5 mb-4 shadow-md border border-warning-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-3">
                    <div>
                        <h3 class="font-bold text-lg text-neutral-900">Ahmad Hidayat</h3>
                ...
                <div class="bg-neutral-50 rounded-xl p-3 mb-3">
                    <p class="text-sm font-semibold text-neutral-700 mb-1">Masalah:</p>
                    <p class="text-neutral-900 font-medium">Ban Bocor - Motor</p>
                </div>
                
                <div class="grid grid-cols-3 gap-2">
                    <button class="py-2.5 text-sm font-semibold text-error-600 bg-error-50 border border-error-300 rounded-lg hover:bg-error-100 transition-all">
                        Tolak
                    </button>
                    <button class="py-2.5 text-sm font-semibold text-success-700 bg-success-50 border border-success-300 rounded-lg hover:bg-success-100 transition-all">
                        Terima
                    </button>
                    <button class="py-2.5 text-sm font-semibold text-success-600 bg-white border border-success-300 rounded-lg hover:bg-success-50 transition-all flex items-center justify-center gap-1">
                ...
                <button onclick="showDetail(1)" class="w-full mt-2 py-2.5 text-sm font-semibold text-primary-700 bg-primary-50 border border-primary-200 rounded-lg hover:bg-primary-100 transition-all">
                    Lihat Detail & Lokasi
                </button>
            </div>

            <!-- Order 2 - Sudah Diterima -->
            <div class="bg-white rounded-2xl p-5 mb-4 shadow-md border border-success-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-3">
                    <div>
                        <h3 class="font-bold text-lg text-neutral-900">Siti Nurhaliza</h3>
                        <div class="flex items-center gap-2 text-sm text-neutral-500 mt-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            </svg>
                ...
                <div class="bg-success-50 rounded-xl p-3 mb-3 border border-success-200">
                    <p class="text-sm font-semibold text-success-700 mb-1">Masalah:</p>
                    <p class="text-neutral-900 font-medium">Service Berkala - Motor</p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <a href="<?php echo e(route('bengkel.final-price', ['id' => 2])); ?>" class="py-2.5 text-sm font-bold text-white bg-secondary-500 rounded-lg hover:bg-secondary-600 transition-all flex items-center justify-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button onclick="showDetail(2)" class="w-full mt-2 py-2.5 text-sm font-semibold text-primary-700 bg-primary-50 border border-primary-200 rounded-lg hover:bg-primary-100 transition-all">
                    Lihat Detail & Lokasi
                </button>
            </div>

            <!-- Order 3 - Sudah Diterima -->
            <div class="bg-white rounded-2xl p-5 mb-4 shadow-md border border-success-200 hover:shadow-lg transition-all">
                <div class="flex items-start justify-between mb-3">
                    <div>
                        <h3 class="font-bold text-lg text-neutral-900">Budi Santoso</h3>
                        <div class="flex items-center gap-2 text-sm text-neutral-500 mt-1">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            </svg>
                ...
                <div class="bg-success-50 rounded-xl p-3 mb-3 border border-success-200">
                    <p class="text-sm font-semibold text-success-700 mb-1">Masalah:</p>
                    <p class="text-neutral-900 font-medium">Ganti Oli & Filter - Motor</p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <a href="<?php echo e(route('bengkel.final-price', ['id' => 3])); ?>" class="py-2.5 text-sm font-bold text-white bg-secondary-500 rounded-lg hover:bg-secondary-600 transition-all flex items-center justify-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        Final Price
                ...
                <button onclick="showDetail(3)" class="w-full mt-2 py-2.5 text-sm font-semibold text-primary-700 bg-primary-50 border border-primary-200 rounded-lg hover:bg-primary-100 transition-all">
                    Lihat Detail & Lokasi
                </button>
            </div>
...
<?php /**PATH C:\Users\Asus\Downloads\Disk D\project\sibantar\resources\views/bengkel/dashboard/index.blade.php ENDPATH**/ ?>