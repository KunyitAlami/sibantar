        ...
        <div class="container mx-auto px-4 py-12 lg:py-20">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-xl">
                    <form action="<?php echo e(route('login')); ?>" method="GET" class="space-y-4">
                        <!-- Jenis Kendaraan -->
                        <div class="text-left">
...
<?php /**PATH C:\Users\Asus\Downloads\Disk D\project\sibantar\resources\views/landing_page.blade.php ENDPATH**/ ?>