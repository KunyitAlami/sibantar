...
<div class="bg-base-100 shadow-md sticky top-0 z-[9999]">
    <div class="navbar container mx-auto">
        ...
        <div class="navbar-start">
            <!-- Logo -->
            <a href="<?php echo e(route('user.search')); ?>" class="btn btn-ghost text-xl px-2 lg:px-4">
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1">
                <li><a href="<?php echo e(route('user.search')); ?>" class="font-medium <?php echo e(request()->routeIs('user.search') ? 'active' : ''); ?>">Cari Bengkel</a></li>
        ...
        <div class="navbar-end gap-2">
            ...
            <div class="dropdown dropdown-end lg:hidden">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    <li><a href="<?php echo e(route('user.search')); ?>" class="font-medium">Cari Bengkel</a></li>
            ...
            <div class="dropdown dropdown-end hidden lg:block">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    ...
                    <li><a href="<?php echo e(route('user.search')); ?>">
