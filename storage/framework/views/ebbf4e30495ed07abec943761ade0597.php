    ...
    <div class="container mx-auto px-4 py-6">
        <div class="max-w-4xl mx-auto">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-base font-semibold text-neutral-900 mt-1"><?php echo e($report->user->username ?? '-'); ?></p>
                                    <?php if($report->user && $report->user->email): ?>
                                        <p class="text-sm text-neutral-600 mt-0.5"><?php echo e($report->user->email); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-base font-semibold text-neutral-900 mt-1"><?php echo e($report->bengkel->nama_bengkel ?? '-'); ?></p>
                                    <?php if($report->bengkel && $report->bengkel->alamat_lengkap): ?>
                                        <p class="text-sm text-neutral-600 mt-0.5"><?php echo e(Str::limit($report->bengkel->alamat_lengkap, 50)); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-neutral-200">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-base font-semibold text-neutral-900 mt-1">#<?php echo e($report->order->id_order ?? '-'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white shadow-md rounded-xl overflow-hidden mb-6">
                ...
                <div class="p-6">
                    <p class="text-neutral-700 leading-relaxed whitespace-pre-line"><?php echo e($report->deskripsi); ?></p>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-xl p-6">
                ...
                <div class="flex flex-wrap gap-3 w-full justify-center">
                    ...
                    <?php if($report->user && $report->user->wa_number): ?>
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $report->user->wa_number)); ?>" 
                           target="_blank"
                    ...
                    <?php if($report->bengkel && $report->bengkel->user && $report->bengkel->user->wa_number): ?>
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $report->bengkel->user->wa_number)); ?>" 
                           target="_blank"
                    ...
                    <!-- Hapus Laporan -->
                    <form action="<?php echo e(route('admin.laporan.hapus', ['type' => $type, 'id' => $report->getKey()])); ?>" 
                        method="POST"
...
<?php endif; ?><?php /**PATH D:\laragon\www\sibantar\resources\views/admin/laporan/laporanDetail.blade.php ENDPATH**/ ?>