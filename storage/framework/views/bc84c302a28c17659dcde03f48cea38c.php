...
<div class="container">
        ...
        <tr>
            ...
            <td style="width: 50%; vertical-align: top; text-align: right;">
                ...
                <div style="font-size: 14px; color: #475569; margin-top: 5px;">
                    #<?php echo e(str_pad($order->id_order, 6, '0', STR_PAD_LEFT)); ?>
        ...
        <tr>
            ...
            <td style="width: 50%; vertical-align: top; padding-right: 10px;">
                ...
                <div class="info-box">
                    ...
                    <div class="info-content">
                        ...
                        <strong>No. WA:</strong> <?php echo e($order->user->wa_number ?? '-'); ?>
                ...
                <div class="info-box">
                    ...
                    <div class="info-content">
                        ...
                        Long: <?php echo e(number_format($order->user_longitude, 6)); ?>
            ...
            <td style="width: 50%; vertical-align: top; padding-left: 10px;">
                ...
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <strong>Nama:</strong> <?php echo e($order->bengkel->nama_bengkel); ?><br>
                        <strong>Kecamatan:</strong> <?php echo e($order->bengkel->kecamatan); ?><br>
                        <strong>Alamat:</strong> <?php echo e($order->bengkel->alamat_lengkap); ?>
                ...
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <strong>Tanggal:</strong> <?php echo e(\Carbon\Carbon::parse($order->created_at)->format('d/m/Y H:i')); ?><br>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td><strong><?php echo e($order->layananBengkel->nama_layanan ?? 'Layanan Bengkel'); ?></strong></td>
    ...
    <div class="footer">
        ...
        <span style="color:#9ca3af;">
            Invoice dibuat otomatis pada <?php echo e(\Carbon\Carbon::now()->format('d F Y, H:i:s')); ?>
...
<?php /**PATH C:\laragon\www\sibantar\resources\views/user/invoice.blade.php ENDPATH**/ ?>