...
<head>
    ...
    <title>Invoice #<?php echo e($order->id_order); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header-left">
                <img src="<?php echo e(public_path('images/logo.png')); ?>" alt="SIBANTAR Logo" class="logo">
                <div class="company-name">SIBANTAR</div>
                <div class="company-tagline">Sistem Informasi Bengkel Antar</div>
            </div>
            <div class="header-right">
                <div class="invoice-title">INVOICE</div>
                <div class="invoice-number">#<?php echo e(str_pad($order->id_order, 6, '0', STR_PAD_LEFT)); ?></div>
            </div>
        </div>
        ...
        <div class="info-section">
            <div class="info-left">
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <strong>Nama:</strong> <?php echo e($order->user->username); ?><br>
                        <strong>Email:</strong> <?php echo e($order->user->email); ?><br>
                        <strong>No. WhatsApp:</strong> <?php echo e($order->user->wa_number ?? '-'); ?><br>
                        <strong>ID User:</strong> #<?php echo e($order->user->id_user); ?>
                ...
                <div class="info-box">
                    ...
                    <div class="info-content">
                        ...
                        Lat: <?php echo e(number_format($order->user_latitude, 6)); ?><br>
                        <span style="margin-left: 20px;">Long: <?php echo e(number_format($order->user_longitude, 6)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="info-right">
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <strong>Nama Bengkel:</strong> <?php echo e($order->bengkel->nama_bengkel); ?><br>
                        <strong>Kecamatan:</strong> <?php echo e($order->bengkel->kecamatan); ?><br>
                        <strong>Alamat:</strong> <?php echo e($order->bengkel->alamat_lengkap); ?><br>
                        <strong>Jam Operasional:</strong> <?php echo e($order->bengkel->jam_operasional); ?>
                ...
                <div class="info-box">
                    ...
                    <div class="info-content">
                        <strong>Tanggal Order:</strong> <?php echo e(\Carbon\Carbon::parse($order->created_at)->format('d/m/Y H:i')); ?><br>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>
                            <strong><?php echo e($order->layananBengkel->nama_layanan ?? 'Layanan Bengkel'); ?></strong><br>
                            <span style="color: #64748b; font-size: 11px;">
                                <?php echo e($order->layananBengkel->deskripsi ?? '-'); ?>
        ...
        <div class="footer">
            ...
            <div style="margin-top: 15px; color: #94a3b8; font-size: 9px;">
                Invoice ini dibuat secara otomatis oleh sistem SIBANTAR pada <?php echo e(\Carbon\Carbon::now()->format('d F Y, H:i:s')); ?><br>
                Dokumen ini sah dan tidak memerlukan tanda tangan
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\laragon\www\sibantar\resources\views/user/invoice.blade.php ENDPATH**/ ?>