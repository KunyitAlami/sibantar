                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex gap-2">
                            <a href="<?php echo e(route('user.bengkel.detail', 1)); ?>" class="btn btn-outline btn-sm flex-1">
                                Detail
                            </a>
                            <a href="<?php echo e(route('user.bengkel.confirmation', 1)); ?>" class="btn btn-primary btn-sm flex-1">
                                Pesan
                            </a>
                        </div>
                    </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex gap-2 mt-3">
                            <a href="<?php echo e(route('user.bengkel.detail', 1)); ?>" class="btn btn-outline btn-sm flex-1">Detail</a>
                            <a href="<?php echo e(route('user.bengkel.confirmation', 1)); ?>" class="btn btn-primary btn-sm flex-1">Pesan</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card p-4 hover:shadow-lg transition cursor-pointer" data-bengkel-id="3" data-lat="-3.3160" data-lng="114.5910">
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex gap-2">
                            <a href="<?php echo e(route('user.bengkel.detail', 3)); ?>" class="btn btn-outline btn-sm flex-1">Detail</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\Asus\Downloads\Disk D\project\sibantar\resources\views/user/search.blade.php ENDPATH**/ ?>