...
<div class="bg-base-100 shadow-md sticky top-0 z-[9999]">
    <div class="navbar container mx-auto">
        ...
        <div class="navbar-start">
            <!-- Logo -->
            <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-ghost text-xl px-2 lg:px-4">
        ...
        <div class="navbar-center hidden lg:flex">
            <ul class="menu menu-horizontal px-1">
                ...
                <li><a href="<?php echo e(route('user.eksplor_bengkel')); ?>" class="font-medium <?php echo e(request()->routeIs('user.eksplor_bengkel') ? 'active' : ''); ?>">Cari Bengkel</a></li>
                <li>
        ...
        <div class="navbar-end gap-2">
            ...
            <div class="dropdown dropdown-end lg:hidden">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    ...
                    <li><a href="<?php echo e(route('user.eksplor_bengkel')); ?>" class="font-medium">Cari Bengkel</a></li>
                    <li>
            ...
            <div class="dropdown dropdown-end hidden lg:block">
                ...
                <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    ...
                    <li><a href="<?php echo e(route('user.eksplor_bengkel')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                        Cari Bengkel
                    ...
                    <li><a href="<?php echo e(route('about_us')); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="divider my-1"></div>
                    <li>
                        <form id="logout-form-desktop" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
                            <?php echo csrf_field(); ?>
                        </form>
...
<?php /**PATH C:\laragon\www\sibantar\resources\views/components/navbar-user.blade.php ENDPATH**/ ?>