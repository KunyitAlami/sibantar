...
<?php $component->withAttributes([]); ?>
    ...
    <section class="px-4">
        <div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-sm mb-20">
            ...
            <form action="<?php echo e(route('admin.tambah-user-store')); ?>" autocomplete="off" method="POST" class="mt-10 mb-10 gap-5">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\sibantar\resources\views/admin/form/tambahUser.blade.php ENDPATH**/ ?>