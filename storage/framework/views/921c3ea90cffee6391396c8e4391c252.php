                ...
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-3">
                        <div id="statusIcon" class="w-10 h-10 rounded-full flex items-center justify-center shadow-md transition-all duration-300
                            <?php echo e(isset($statusBengkel) && $statusBengkel->status == 'buka' ? 'bg-success-500' : 'bg-danger-500'); ?>">
                            <svg id="statusIconSvg" class="w-6 h-6 text-white transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <?php if(isset($statusBengkel) && $statusBengkel->status == 'buka'): ?>
                        ...
                        <div>
                            ...
                            <p class="text-xs text-primary-100 transition-all duration-300" id="statusText">
                                <?php echo e(isset($statusBengkel) && $statusBengkel->status == 'buka' 
                    ...
                    <label class="relative inline-block w-16 h-9">
                        <input type="checkbox" id="statusToggle" class="sr-only peer" 
                            <?php echo e(isset($statusBengkel) && $statusBengkel->status == 'buka' ? 'checked' : ''); ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const bengkelId = <?php echo e($id_Bengkel ?? 0); ?>;
    ...
    toggle.addEventListener('change', function() {
        ...
        fetch(`<?php echo e(route('bengkel.updateStatus', ['id' => ':id'])); ?>`.replace(':id', bengkelId), {
            method: 'POST',
            headers: {
...
</script><?php /**PATH C:\laragon\www\sibantar\resources\views/bengkel/dashboard/index.blade.php ENDPATH**/ ?>