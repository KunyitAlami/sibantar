...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center mt-5 sm:mt-6 text-sm text-neutral-600">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="text-primary-700 hover:text-primary-800 font-semibold">
                    Daftar sekarang
                </a>
            </p>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\sibantar\resources\views/user/auth/login.blade.php ENDPATH**/ ?>