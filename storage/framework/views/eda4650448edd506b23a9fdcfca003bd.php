    ...
    <section class="min-h-screen flex items-center justify-center py-8 sm:py-12 px-4 bg-neutral-50">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-6 sm:mb-8">
                ...
                <p class="text-sm sm:text-base text-neutral-600">Daftar untuk mulai menggunakan SIBANTAR [ini di Folder AUTH]</p>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Asus\Downloads\Disk D\project\sibantar\resources\views/Auth/register.blade.php ENDPATH**/ ?>