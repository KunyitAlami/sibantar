    ...
    <section class="bg-white border-b border-neutral-200 sticky top-0 z-50 mb-5">
        <div class="container mx-auto px-4">
            <div class="flex items-center gap-4 py-4">
                <a href="<?php echo e(route('bengkel.dashboard', ['id_bengkel' => $layanan_bengkel->id_bengkel])); ?>"
            ...
            <form action="<?php echo e(route('bengkel.layanan.update', $id_layanan_bengkel)); ?>" method="POST" class="mt-10 mb-10 gap-5">
                ...
                <div class="space-y-5">
                    <div class="flex-1">
                        ...
                        <input type="number" name="harga_awal" required value="<?php echo e($layanan_bengkel->id_layanan_bengkel); ?>" disabled
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_layanan" required value="<?php echo e($layanan_bengkel->nama_layanan); ?>"
                            class="w-full border border-neutral-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary-500">
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row gap-5">
                        <div class="flex-1">
                            ...
                            <textarea name="deskripsi" rows="4" required class="w-full border border-neutral-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary-500"><?php echo e(old('deskripsi', $layanan_bengkel->deskripsi)); ?></textarea>
                        </div>
                        ...
                        <div class="flex-1">
                            <label class="block font-medium text-neutral-800 mb-1">Kategori</label>
                                <select name="kategori" required
                                    ...
                                    <option value="Motor" <?php echo e($layanan_bengkel->kategori == 'Motor' ? 'selected' : ''); ?>>Motor</option>
                                    <option value="Mobil" <?php echo e($layanan_bengkel->kategori == 'Mobil' ? 'selected' : ''); ?>>Mobil</option>
                                    <option value="Truk"  <?php echo e($layanan_bengkel->kategori == 'Truk' ? 'selected' : ''); ?>>Truk</option>
                                </select>
                ...
                <input type="hidden" name="id_bengkel" value="<?php echo e($layanan_bengkel->id_bengkel); ?>">
            </form>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\sibantar\resources\views/bengkel/form/editLayanan.blade.php ENDPATH**/ ?>